...
<span class="prose-a:text-neutral-600 text-neutral-500">
  A sporadically updated log on what's keeping me busy. Inspired by the [Now
  page movement](https://nownownow.com) started by [Derek
  Sivers](https://sive.rs). My entry lives [here](https://nownownow.com/p/Gh39).
</span>
